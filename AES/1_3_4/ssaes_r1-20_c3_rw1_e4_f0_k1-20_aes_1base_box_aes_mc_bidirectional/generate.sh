...
# Generating 400 key discovery instances for AES(r,1,3,4) using the 1base
...
# All files are in:
#
# ssaes_r1-20_c3_rw1_e4_f0_k1-20_aes_1base_box_aes_mc_bidirectional .
#
...
translation_param=rbase # canonical (this will be fixed)
mixcolumns=bidirectional # Forward and backward translation
rounds=20
keys=20


box_generation="output_fcs(\"1-base representation for small-scale AES 4-bit S-box\", ev_hm(ss_sbox_rbase_cnfs,4), \"Sbox_4_1base.cnf\");"
