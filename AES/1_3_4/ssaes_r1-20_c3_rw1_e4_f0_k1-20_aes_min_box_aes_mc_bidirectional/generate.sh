...
# Generating 400 key discovery instances for AES(r,1,3,4) using the minimum
...
# All files are in:
#
# ssaes_r1-20_c3_rw1_e4_f0_k1-20_aes_min_box_aes_mc_bidirectional .
#
...
num_cols=3
field_size=4
translation_name=min
translation_param=small # canonical (this will be fixed)
mixcolumns=bidirectional # Forward and backward translation
rounds=20
keys=20


box_generation="output_fcs(\"Minimum representation for small-scale AES 4-bit S-box\", ev_hm(ss_sbox_cnfs,4), \"Sbox_4_min.cnf\");"
