...
# Generating 400 key discovery instances for AES(r,1,2,8) using the minimum
...
# All files are in:
#
# ssaes_r1-20_c2_rw1_e8_f0_k1-20_aes_min_box_aes_mc_bidirectional .
#
...
translation_param=small
mixcolumns=bidirectional # Forward and backward translation
rounds=20
keys=20


box_generation="output_fcs(\"Minimum representation for small-scale AES 8-bit S-box\", ev_hm(ss_sbox_cnfs,8), \"Sbox_8_min.cnf\");"
